...
static  CPU_STK      AppTaskFourStk[APP_TASK_THREE_STK_SIZE];
...
{ 
    ...
    {
      for(i=0; i <ONESECONDTICK/1.020484;i++){
        j=2*i;
      }
     }
...
{   
    ...
    {
      for(i=0; i < ONESECONDTICK/1.02085; i++){
        j=2*i;
      }
     }
...
{   
   ...
   for(k=0; k<WORKLOAD3; k++)
    {
      for(i=0; i <ONESECONDTICK/1.0207; i++){
        j++;
      }
     }
